...
public class NowPlayingAdapter extends RecyclerView.Adapter<NowPlayingAdapter.MovieViewHolder> {
    ...
    public NowPlayingAdapter(Context mContext) {
    ...
    public MovieViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.item_now_playing, parent, false);
        NowPlayingAdapter.MovieViewHolder viewHolder = new NowPlayingAdapter.MovieViewHolder(view);
        return viewHolder;
    }
    ...
    public class MovieViewHolder extends RecyclerView.ViewHolder {
        ...
        public MovieViewHolder(View itemView) {
            ...
            title =(TextView) itemView.findViewById(R.id.tv_list_itemnowplaying_title);
            rank = (TextView) itemView.findViewById(R.id.tv_list_itemnowplaying_rank);
            releaseDate = (TextView) itemView.findViewById(R.id.tv_list_itemnowplaying_date);
            poster = (ImageView) itemView.findViewById(R.id.iv_list_itemnowplaying_image);
        }
